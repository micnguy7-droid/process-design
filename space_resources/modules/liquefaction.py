...
# Constants
# [K] - Temperature of the cold reservoir for the Carnot cycle
...
# [J/mol] - Enthalpy of vaporization for oxygen
vaporization_enthalpy_oxygen = 6800
...
def liquefaction(cryocooler_efficiency=0.2, T_hot_reservoir_carnot_cycle=233, T_of_incoming_oxygen=340):
    ...
    print("Work required to liquefy 1 mol of O2:",
          work_per_mol_O2, "[kWh/mol]")
