...
# Default system efficiency [-] (from HyLYZER datasheet)
system_efficiency = 0.6
# Efficiency reduction factor [-] (from Beth Lomax paper)
efficiency_reduction = 0.11
...
def electrolysis_energy_per_mol_H2O(system_efficiency=0.6, verbose=False):
    ...
    total_efficiency = system_efficiency - \
        (system_efficiency * efficiency_reduction)
    ...
    if verbose:
        print('Electrolysis energy per mol H2O:',
              electrolysis_energy_per_mol_H2O, "[kWh/mol]")
        print('Energy per kg of liquid oxygen (LOX):',
              electrolysis_energy_per_mol_H2O * 2 * 1000 / 32, "[kWh/kg]")
        print('Energy per kg of water:',
              electrolysis_energy_per_mol_H2O * 1000 / 18, "[kWh/kg]")
