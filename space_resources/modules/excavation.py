...
EnergyReqTptPerDistEmpty = energy_requirements(MinSlipEmpty, mRover + mRegolith, velocityExcavation, WheelWidthVal, WheelRadiusVal, SlopeVal, wheelbaseVal,
                                               # [J/m] Energy requirements for transport during excavation (empty rover)
                                               heightCOGVal, gVal, nVal, kcVal, kphiVal, cVal, kVal, phiVal, motor_efficiencyVal)
...
MinSlipFull = slip_required(mRover + mRegolith, gVal, WheelWidthVal, WheelRadiusVal, SlopeVal, wheelbaseVal,
                            # The minimum slip when the rover is full
                            heightCOGVal, nVal, kcVal, kphiVal, cVal, kVal, phiVal)
...
EnergyReqTptPerDistFull = energy_requirements(MinSlipFull, mRover + mRegolith, velocityExcavation, WheelWidthVal, WheelRadiusVal, SlopeVal, wheelbaseVal,
                                              # [J/m] Energy requirements for transport during excavation (full rover)
                                              heightCOGVal, gVal, nVal, kcVal, kphiVal, cVal, kVal, phiVal, motor_efficiencyVal)
...
def get_Alpha(cohCoeff_input, intAngle_input, extAngle_input, motor_efficiency_input, mRover_input):
    ...
    EnergyReqTptPerDistEmpty = energy_requirements(MinSlipEmpty, mRover_input + mRegolith, velocityExcavation, WheelWidthVal, WheelRadiusVal, SlopeVal, wheelbaseVal,
                                                   # [J/m] Energy requirements for transport during excavation (empty rover)
                                                   heightCOGVal, gVal, nVal, kcVal, kphiVal, cVal, kVal, phiVal, motor_efficiency_input)
    ...
    digOutputs = excavationMechanics(
        depthM, trenchDepthM, radiusM, extAngle_input, intAngle_input, cohCoeff_input, gVal, mRegolith)
